...
# Custom function to convert NumPy arrays to lists
...
def convert_to_numpy(obj):
    if isinstance(obj, list):  # Convert lists back to NumPy arrays
        return np.array(obj)
...
class DefaultPredictor:
    ...
    def __init__(self, cfg):
        ...
        print('LOADING MODEL .....', cfg.MODEL.WEIGHTS)
    ...
    def __call__(self, original_image, grid_path):
        ...
        with torch.no_grad():  # https://github.com/sphinx-doc/sphinx/issues/4258
            ...
            # with open('/home/ng6309/datascience/rakesh/GenAI_Platform/common_modules/src/grid_output.json', 'r') as f:
            #     sample_inputs = json.load(f)
            #     sample_inputs = json.loads(json.dumps(sample_inputs), object_hook=convert_to_numpy)
